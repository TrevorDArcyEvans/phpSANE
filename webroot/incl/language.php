...
$lang[4] = array(
    ...
    "Other",               // 31
		"ОШИБКА",              // 32
		"Сканеры не обнаружены.<br>Проверьте подключение через программу sane-find-scanner (если установлена).<br>Или почитайте дополнительные инструкции (README, FAQ, manpages).", // 33
		"Повторить",           // 34
		"Правая кнопка - сохранить", // 35
    "Закрыть",             // 36
    "Помощь",              // 37
    "Дополнительные параметры", // 38
    "Нет комманды сканирования", // 39
    "Формат страницы",     // 40
    "Название файла",      // 41
    "Сканировать",         // 42
    "PDF document",        // 43
...
$lang[5] = array(
    ...
    "Other",               // 31
		"Помилка",             // 32
		"Сканери не знайдені.<br>Перевірте підключення через програму sane-find-scanner (якщо встановлена).<br>Або почитайте додаткові інструкції (README, FAQ, manpages).", // 33
		"Повторити",           // 34
		"Правая кнопка - зберегти", // 35
		"Закрити",             // 36
		"Допомога",            // 37
		"Додаткові параметри", // 38
		"Немає комманди сканування", // 39
		"Формат сторінки",     // 40
	  "Назва файлу",         // 41
	  "Сканувати",           // 42
	  "PDF document",        // 43
